<template>
	<div id="cateMain">
		<div class="has-categories-list" v-if="historySeen != ''">
					...
					<div class="row">
						<div class="col-md-12">
							<ul class="breadcrumb">
								...
								<li style="width: 50%;"><a href="javascript:void(0)"><span>Sản phẩm bạn đã xem</span></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<template v-if="checkResponsive">
						...
						<div class="title col-md-12">
							<h2>SẢN PHẨM CỦA BLOOD SHOPPING MALL</h2>
						</div>
						<div class="col-md-12">
							<div class="content-had" v-if="historySeen != ''">
								<div v-for="product in historySeen" v-bind:key="product.id_number" class="item col-xs-4 col-md-5ths">
									<div class="item-product" @click="seenProductDetail(product)">
										...
										<div class="info-product">
											...
											<div class="quantity-freeShip">
												<i>Còn lại: </i><span>{{product.total_quantity}}</span>
					...
					<template v-else>
						<notifications group="auth" style="width: 70%; top: 42px; right: 0px;"/>
						<div class="title" style="margin: 15px 0 10px 0; width: 100%;">
							<h2 style="margin-bottom: 0; padding: 0 10px;">SẢN PHẨM ĐÃ XEM</h2>
						</div>
						<div class="content-had" v-if="historySeen != ''">
							<div v-for="product in historySeen" :key="product.id_number" class="item col-6 col-md-6 col-xs-6 col-sm-4 col-lg-3 col-xl-3">
								<div class="item-product" @click="seenProductDetail(product)">
									<div class="image-product">
										<nuxt-link :to="'/product/'+product.link"><a href="#"><img v-bind:src="$store.state.apiApp + 'products/' + product.image_main" alt="" /></a></nuxt-link>	 
									</div>
				...
				<div class="clickSeen-History"><button @click="clickDeleteHistory">Xóa lịch sử</button> </div>
			</div>
		</div>
	...
	export default {
		...
		methods:{
			...
			clickDeleteHistory(){
				...
				this.$notify({ group: "auth", title: "Success", text: "Delete successes.", type: "success" });
