            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="d-block text-center card-footer">
                        ...
                        <button class="btn-wide btn btn-primary">Thêm môn học</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        mounted(){
            if ( !this.$store.state.userInfo.successes) { this.$router.push({path:'/login'})  } 
                ...
                if(this.$store.state.userInfo.data.decentralise === "t" || this.$store.state.userInfo.data.decentralise === "s") { this.$router.push({path:'/login'})  } 
